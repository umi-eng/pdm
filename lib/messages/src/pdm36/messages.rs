...
#[allow(dead_code)]
pub const DBC_FILE_NAME: &str = "pdm36";
...
impl defmt::Format for SystemStatus {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            ...
            self.can_rx_errors(), self.can_tx_errors(), self.temperature(),
        );
    }
}
/// Current_Sense
...
impl CurrentSense {
    pub const MESSAGE_ID: embedded_can::Id = Id::Standard(unsafe {
        StandardId::new_unchecked(0x1055)
    });
    pub const MUX_MIN: u8 = 0_u8;
    pub const MUX_MAX: u8 = 15_u8;
...
impl AnalogInputs {
    pub const MESSAGE_ID: embedded_can::Id = Id::Standard(unsafe {
        StandardId::new_unchecked(0x1155)
    });
