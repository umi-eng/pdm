...
impl Configure {
    ...
    pub const MUX_MIN: u8 = 0_u8;
    pub const MUX_MAX: u8 = 15_u8;
    pub const CHANNEL_MASK_MIN: u16 = 0_u16;
    pub const CHANNEL_MASK_MAX: u16 = 4095_u16;
    pub const BLANKING_WINDOW_MIN: u8 = 0_u8;
    pub const BLANKING_WINDOW_MAX: u8 = 16_u8;
    pub const CURRENT_LIMIT_MIN: u8 = 0_u8;
    pub const CURRENT_LIMIT_MAX: u8 = 255_u8;
    pub const ECONOMIZE_DUTY_MIN: u8 = 0_u8;
    pub const ECONOMIZE_DUTY_MAX: u8 = 255_u8;
    ...
    pub fn new(mux: u8, channel_mask: u16, open_load_detection: bool, blanking_window: u8, current_limit: u8, economize_duty: u8, economize_delay: u8) -> Result<Self, CanError> {
        ...
        res.set_mux(mux)?;
        res.set_channel_mask(channel_mask)?;
        res.set_open_load_detection(open_load_detection)?;
        res.set_blanking_window(blanking_window)?;
        res.set_current_limit(current_limit)?;
        res.set_economize_duty(economize_duty)?;
        res.set_economize_delay(economize_delay)?;
        Ok(res)
    }
    ...
    /// - Min: 0
    /// - Max: 4095
    /// - Unit: "Output channel mask"
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn channel_mask(&self) -> u16 {
        self.channel_mask_raw()
    }
    
    /// Get raw value of Channel_Mask
    ///
    /// - Start bit: 4
    /// - Signal size: 12 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn channel_mask_raw(&self) -> u16 {
    ...
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn open_load_detection(&self) -> bool {
        self.open_load_detection_raw()
    }
    
    /// Get raw value of Open_Load_Detection
    ///
    /// - Start bit: 16
    /// - Signal size: 1 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn open_load_detection_raw(&self) -> bool {
        let signal = self.raw.view_bits::<Lsb0>()[16..17].load_le::<u8>();
        
        signal == 1
    }
    
    /// Set value of Open_Load_Detection
    #[inline(always)]
    pub fn set_open_load_detection(&mut self, value: bool) -> Result<(), CanError> {
    ...
    /// - Min: 0
    /// - Max: 16
    /// - Unit: "Blanking time. 0 for latch-off. Refer to datasheet for timing."
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn blanking_window(&self) -> u8 {
        self.blanking_window_raw()
    }
    
    /// Get raw value of Blanking_Window
    ///
    /// - Start bit: 20
    /// - Signal size: 2 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn blanking_window_raw(&self) -> u8 {
        let signal = self.raw.view_bits::<Lsb0>()[20..22].load_le::<u8>();
    ...
    /// - Min: 0
    /// - Max: 255
    /// - Unit: "Current limit - 100mA per bit"
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn current_limit(&self) -> u8 {
        self.current_limit_raw()
    }
    
    /// Get raw value of Current_Limit
    ///
    /// - Start bit: 24
    /// - Signal size: 8 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn current_limit_raw(&self) -> u8 {
    ...
    /// - Min: 0
    /// - Max: 255
    /// - Unit: "Coil economization PWM duty"
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn economize_duty(&self) -> u8 {
        self.economize_duty_raw()
    }
    
    /// Get raw value of Economize_Duty
    ///
    /// - Start bit: 32
    /// - Signal size: 8 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn economize_duty_raw(&self) -> u8 {
    ...
    /// - Min: 0
    /// - Max: 16
    /// - Unit: "Coil economization delay - 50ms per bit"
    /// - Receivers: Vector__XXX
    #[inline(always)]
    pub fn economize_delay(&self) -> u8 {
        self.economize_delay_raw()
    }
    
    /// Get raw value of Economize_Delay
    ///
    /// - Start bit: 40
    /// - Signal size: 4 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn economize_delay_raw(&self) -> u8 {
